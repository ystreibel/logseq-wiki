...
Human curates sources and asks questions; LLM maintains the knowledge system. Logseq becomes the IDE, the LLM becomes the programmer, and the wiki becomes the codebase.
...
- **Logseq** — IDE for browsing and exploring the wiki
- **Web Clipper** — Browser extension for converting articles to markdown
- **Marp** — Markdown-based slide decks from wiki content
- **Logseq queries** — Built-in query language for filtering pages and blocks
