...
**Write a `summary::` property** on every new/updated page — 1–2 sentences, ≤200 chars, answering "what is this page about?" for a reader who hasn't opened it. This feeds cheap retrieval in `wiki-query`.
